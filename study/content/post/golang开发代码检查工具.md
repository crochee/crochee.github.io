...
官网：https://github.com/golangci/golangci-lint   
本地下载go get -u github.com/golangci/golangci-lint/cmd/golangci-lint   
启动参考：golangci-lint run -c golangci-lint.yml --tests=false  --out-format=json  > golangci-lint.json 2>&1   
参考配置:
```yaml
run:
